...
export const WORLD_FEATURES: WorldFeaturePoint[] = [
  ...
  { id: 'beach_volleyball', x: 41.5, z: -55, radius: 3.2, hint: '按 E 挑战沙滩排球' },
  {
    ...
    x: MAP_LAYOUT.plaza.pos[0] - 2,
    z: MAP_LAYOUT.plaza.pos[2] + 10,
    radius: 2.2,
    hint: '按 E 看看花艺摊',
  },
  {
    id: 'village_stall_tao',
    x: MAP_LAYOUT.plaza.pos[0] + 8,
    z: MAP_LAYOUT.plaza.pos[2] + 8,
    radius: 2.2,
    hint: '按 E 看看渔具摊',
  },
  {
    id: 'village_stall_lina',
    x: MAP_LAYOUT.plaza.pos[0] + 11,
    z: MAP_LAYOUT.plaza.pos[2] - 7,
    radius: 2.2,
    hint: '按 E 看看木工摊',
  },
];
