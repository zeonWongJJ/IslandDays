...
export const LANDMARKS = {
  ...
  garden: {
    center: { id: 'garden-center', x: 56, z: -10 },
    beds: [
    ...
    fences: [
      ...
      { id: 'garden-fence-c', x: 57, z: -16.3, rot: Math.PI / 2 - 0.2 },
      { id: 'garden-fence-d', x: 60, z: -16.9, rot: Math.PI / 2 - 0.2 },
      { id: 'garden-fence-e', x: 62.5, z: -8, rot: -0.2 },
      { id: 'garden-fence-f', x: 63, z: -5, rot: -0.2 },
    ] satisfies LandmarkPoint[],
  },
  lookout: {
  ...
  forestRuins: {
    ...
    trees: [
      ...
      { id: 'ruin-tree-h', x: -42.5, z: 36.2, rot: 1.4 },
    ] satisfies LandmarkPoint[],
  },
} as const;
