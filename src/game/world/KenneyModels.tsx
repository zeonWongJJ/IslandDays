...
const DROP_MODEL_CFG: Partial<Record<ItemId, DropModelCfg>> = {
  ...
  fish_bluegill: { path: FISH_MODEL_PATH, size: 0.45, rotation: [0, -Math.PI / 2, 0] },
  fish_loach: { path: FISH_MODEL_PATH, size: 0.42, rotation: [0, -Math.PI / 2, 0] },
  fish_salmon: { path: FISH_MODEL_PATH, size: 0.58, rotation: [0, -Math.PI / 2, 0] },
  fish_mackerel: { path: FISH_MODEL_PATH, size: 0.55, rotation: [0, -Math.PI / 2, 0] },
  fish_rare: { path: FISH_MODEL_PATH, size: 0.62, rotation: [0, -Math.PI / 2, 0] },
  fish_mahi_mahi: { path: FISH_MODEL_PATH, size: 0.67, rotation: [0, -Math.PI / 2, 0] },
  fish_legend: { path: FISH_MODEL_PATH, size: 0.72, rotation: [0, -Math.PI / 2, 0] },
  bug_common: { path: BUG_MODEL_PATHS[0], size: 0.5 },
  bug_cicada: { path: BUG_MODEL_PATHS[0], size: 0.45 },
  bug_beetle: { path: BUG_MODEL_PATHS[0], size: 0.52 },
  bug_dragonfly: { path: BUG_MODEL_PATHS[0], size: 0.55 },
  bug_moth: { path: BUG_MODEL_PATHS[0], size: 0.48 },
